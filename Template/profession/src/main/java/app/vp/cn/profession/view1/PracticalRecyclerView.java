...
public class PracticalRecyclerView extends FrameLayout {
    ...
    private OnVisibleItemPositionListener mOnVisibleItemPositionListener;

    private FrameLayout mMainContainer;
    private FrameLayout mLoadingContainer;
    private FrameLayout mErrorContainer;
    private FrameLayout mNoNetContainer;
    private FrameLayout mEmptyContainer;
    private FrameLayout mNoLocationContainer;
    ...
    public void setOnVisibleItemPositionListener(OnVisibleItemPositionListener onVisibleItemPositionListener) {
        if (onVisibleItemPositionListener == null) return;
        mOnVisibleItemPositionListener = onVisibleItemPositionListener;
    }
    ...
    void displayLoadingAndResetStatus() {
        ...
        mNoNetContainer.setVisibility(GONE);
        mNoLocationContainer.setVisibility(GONE);
    ...
    void displayNoNetAndResetStatus() {
        mLoadingContainer.setVisibility(GONE);
        mContentContainer.setVisibility(GONE);
        mEmptyContainer.setVisibility(GONE);
        mErrorContainer.setVisibility(GONE);
        mNoLocationContainer.setVisibility(GONE);
        mNoNetContainer.setVisibility(VISIBLE);
        resetStatus();
    }
    void displayNoLocationAndResetStatus() {
        mLoadingContainer.setVisibility(GONE);
        mContentContainer.setVisibility(GONE);
        mEmptyContainer.setVisibility(GONE);
        mErrorContainer.setVisibility(GONE);
        mNoNetContainer.setVisibility(GONE);
        mNoLocationContainer.setVisibility(VISIBLE);
        resetStatus();
    }
    ...
    private void initMainView(Context context) {
        ...
        mNoNetContainer = (FrameLayout) mMainContainer.findViewById(R.id.practical_nonet);
        mNoLocationContainer = (FrameLayout) mMainContainer.findViewById(R.id.practical_no_location);
        mEmptyContainer = (FrameLayout) mMainContainer.findViewById(R.id.practical_empty);
        mContentContainer = (RelativeLayout) mMainContainer.findViewById(R.id.practical_content);

        mSwipeRefreshLayout = (MultiSwipeRefreshLayout) mMainContainer.findViewById(R.id.practical_swipe_refresh);
        mRecyclerView = (RecyclerView) mMainContainer.findViewById(R.id.practical_recycler);
        mSwipeRefreshLayout.setSwipeableChildren(R.id.practical_recycler, R.id.practical_loading,
                R.id.practical_error, R.id.practical_nonet,R.id.practical_no_location, R.id.practical_empty, R.id.practical_content);
    }
    ...
    public void setEnableClickNoNetView(boolean isEnable) {
        if (mNoNetView != null) mNoNetView.setEnabled(isEnable);
    }
    ...
    private void obtainStyledAttributes(Context context, AttributeSet attrs) {
        ...
        int noNetResId = attributes.getResourceId(R.styleable.PracticalRecyclerView_nonet_layout, R.layout
                .default_nonet_layout);
        ...
        int noLocationResId = attributes.getResourceId(R.styleable.PracticalRecyclerView_no_location_layout, R.layout.default_empty_layout);
        ...
        mNoNetView = LayoutInflater.from(context).inflate(noNetResId, mNoNetContainer, true);
        mNoLocationView=LayoutInflater.from(context).inflate(noLocationResId,mNoLocationContainer,true);
    ...
    public interface OnVisibleItemPositionListener {
    ...
    private class OnScrollListener extends RecyclerView.OnScrollListener {
        ...
        public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
            ...
            if (mShouldSmoothMove) {
                mShouldSmoothMove = false;
        ...
        public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
            ...
            if (layoutManager instanceof LinearLayoutManager) {
                ...
                if (firstCompletely != 0) {
                    if (mOnVisibleItemPositionListener != null) {
                        mOnVisibleItemPositionListener.onScrollDown();
                    }
                } else {
                    if (mOnVisibleItemPositionListener != null) {
                        mOnVisibleItemPositionListener.onScrollTop();
                    }
                }
            }
    ...
    //目标项是否在最后一个可见项之后
    private boolean mShouldSmoothMove;
    //记录目标项位置
