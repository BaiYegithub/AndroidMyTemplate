...
public class LunarCalendarUtils {
    ...
    public static int[] lunarToSolar(int year, int month, int monthDay)
    {
        ...
        int basemonth = (LUNAR_INFO[year - MIN_YEAR] & 0x0060) >> 5;
        ...
        for (i = 1; i < pos; i++)
        {
            dayOffset += daysInLunarMonth(year,i);
        }
        //加上农历日的天数差
        dayOffset += monthDay;

        //阳历已跨年处理
        int yeardays = CalendarUtils.daysInYear(year);
        ...
        for (i = 1; i < 13; i++)
        {
            boolean isleap = CalendarUtils.isLeapYear(year);
     ...
     * 类描述：   
     * 创建人：pan
     * 创建时间：2017-5-3 下午7:10:19   
     * 修改人：pan
     * 修改时间：2017-5-3 下午7:10:19   
     * 修改备注：   
     * @version
     */
     ...
     * 类描述：   
     * 创建人：pan
     * 创建时间：2017-5-3 下午7:10:37   
     * 修改人：pan
     * 修改时间：2017-5-3 下午7:10:37   
     * 修改备注：   
     * @version
     */
