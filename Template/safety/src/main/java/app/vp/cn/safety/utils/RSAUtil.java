package app.vp.cn.safety.utils;
...
public class RSAUtil {
     ...
     * @return 使用 公钥加密json
     */
    public static String encryptDataByPublicKey(String data, String strPublicKey) {
        byte[] resultBytes = processData(data.getBytes(), keyStrToPublicKey(strPublicKey), Cipher.ENCRYPT_MODE);
     ...
     */
    public static String decryptedToStrByPrivate(String encryptedData, String strPrivateKey) {
        byte[] bytes = Base64.decode(encryptedData, sBase64Mode);
        return new String(processData(bytes, keyStrToPrivate(strPrivateKey), Cipher.DECRYPT_MODE));
    }
   ...
   /* public static String decryptedToStrByPrivate(String encryptedData, PrivateKey privateKey, String charset) {
     ...
     * @return
     */
    public static String encryptDataByPrivateKey(String data, String strPrivateKey) {
        byte[] resultBytes = processData(data.getBytes(), keyStrToPrivate(strPrivateKey), Cipher.ENCRYPT_MODE);
        return Base64.encodeToString(resultBytes, sBase64Mode);
    }
     ...
     */
    public static String decryptedToStrByPublicKey(String encryptedData, String strPublicKey) {

        byte[] bytes = Base64.decode(encryptedData, sBase64Mode);

        return new String(processData(bytes, keyStrToPublicKey(strPublicKey), Cipher.DECRYPT_MODE));
    }  
