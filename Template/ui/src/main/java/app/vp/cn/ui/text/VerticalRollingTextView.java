...
import app.vp.cn.ui.text.strategy.IStrategy;
import app.vp.cn.ui.text.strategy.MultiLineStrategy;
import app.vp.cn.ui.text.strategy.SingleLineStrategy;
...
public class VerticalRollingTextView extends TextView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            if(mScrollY<=45){ //设置透明度的变换
                mPaint.setAlpha((99-(int) mScrollY)*255/100);
            }else {
                mPaint.setAlpha((int) (mScrollY*255/100));
            }

            Log.i("sss", "onDraw: mScrollY的值是"+mScrollY);
