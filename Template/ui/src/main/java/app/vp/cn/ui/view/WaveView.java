...
public class WaveView extends View {
    ...
    private void initPaint(Context context) {
        ...
        textPaint.setColor(Color.parseColor("#F80303"));
    ...
    private void drawCicleBorder(Canvas canvas) {
        ...
        //  canvas.drawBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.bg_ball),0,0,circlePaint);
